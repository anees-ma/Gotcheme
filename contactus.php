...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Contact us - Performance Chemicals and Additives for Home & Personal Care, Water Treatment, Oil & Gas and Construction Industries | Gotche</title>
...
<body class="stretched">
	...
	<?php include 'header.php'; ?>
		...
		<section id="page-title"  style="background-image:url(img/contactus-banner.jpg);">
